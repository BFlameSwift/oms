 ...
 */
public class Menu {
    public static ArrayList<Dish> allDish = new ArrayList<>(1000);
    ...
    public static Dish getDishById(String did){
    ...
    public static Dish getDishByName(String name){
        for (Dish now : allDish) {
            if (now.getDishName().equals(name)) {
                return now;
            }
        }
        return null;
    ...
    public static ArrayList<Dish> getDishByKeyWord(String keyword){
    ...
    public static Comparator<Dish> comparator = new Comparator<>() {
        @Override
...
//                String[] optionDish = {"H","C","O"};
                ...
                int thisNum = Integer.parseInt(o1.getDishId().substring(1));
                int oNum = Integer.parseInt(o2.getDishId().substring(1));
                return thisNum - oNum;
            }
        }
    };

    public static void menuCommandGd(String[] subCommand){
    ...
    public static void menuCommandUdd( String[] subCommand){
    ...
    public static void menuCommandNd(String[] subCommand){
        int subCommandLen = subCommand.length;
    ...
    public static void menuCommandPm(String[] subCommand){
        int subCommandLen = subCommand.length;
...
//                showMenu(menu.allDish,1,10000);
    ...
    public  static  boolean checkNdNameIsExist(String name){
        for (Dish dish : allDish) {
            String thisDishName = dish.getDishName();
